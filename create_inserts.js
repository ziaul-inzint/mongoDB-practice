...
// db.product.insertOne({ name: "Jane", age: 29 });
...
//db.product.insertMany([{'name':'Jane', 'age':29}, {'name':'arjun', 'age':'30'}])
...
//   [
//     { name: "Jane", age: 29 },
//     { _id: ObjectId("64cb3ea5be4cb31d576182a3"), name: "john" },
//     { name: "ram", age: "30" },
//   ],
//   { ordered: false }
// );
...
// db.Product.insertOne({name:"john",age:30})
// vs
// db.product.insertOne({name:"john",age:30})
